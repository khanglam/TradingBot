...
SYMBOLS=crypto/BTC_USDT_4h python loop.py --iters 20
SYMBOLS=stocks/TSLA_1d     python loop.py --iters 20
...
<!-- AI assistants: append new rules below this line as you learn project conventions. Do not edit above. -->
<!-- Format: N. [CATEGORY] Rule — because reason. Categories: [STYLE] [CODE] [ARCH] [TOOL] [PROCESS] [DATA] [UX] -->
